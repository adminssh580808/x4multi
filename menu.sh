...
echo -e " ${YELLOW} ------------------------------------------ ${NC}"
echo -e "  ${PURPLE} CRON =${NC} $BCD1     ${PURPLE} NGINX =${NC} $BCD2     ${PURPLE} XRAY =${NC} $BCD3  "
echo -e " ${YELLOW} ------------------------------------------ ${NC}"
...
echo -e "    ${GREEN} 5${NC}${LIGHT}). ${NC}${LIGHT}ADD SUBDOMAIN${NC}"
echo -e "    ${GREEN} 6${NC}${LIGHT}). ${NC}${LIGHT}RENEW CERT XRAY${NC}"
echo -e "    ${GREEN} 7${NC}${LIGHT}). ${NC}${LIGHT}CHECK USAGE RAM${NC}"
echo -e "    ${GREEN} 8${NC}${LIGHT}). ${NC}${LIGHT}CHECK BANDWIDTH SYSTEM${NC}"
